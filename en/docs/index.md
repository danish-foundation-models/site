...
<a class="story-card story-card-featured" href="./news/2026/08/14/mimir-1-release-note.html">
  <span class="story-card-title">DFM Mimir v1 release note</span>
  <span class="story-card-desc">A 1B-parameter HRM language model trained from scratch on fully permissible data, delivering frontier performance for Danish and English.</span>
</a>
